...
\include{1_coleman/1_1_intro}
\include{1_coleman/1_2_mf}
%\include{1_coleman/1_3_mc}
%\include{1_coleman/1_4_hecke}
%\include{1_coleman/1_5_coleman}
\include{1_coleman/1_6_algorithm}
%\include{1_coleman/1_7_basis}
%\include{1_coleman/1_8_heckedouble}
%\include{1_coleman/1_9_tinyintegrals}
\include{1_coleman/1_10_examples}
\include{1_coleman/1_11_X0}
\include{1_coleman/1_12_X0plus}
\include{1_coleman/1_13_Xns}
\include{1_coleman/1_14_conclusion}

\part{Decoding Failures of BIKE}
\include{2_bike/2_1_intro}
\include{2_bike/2_2_prelim}
\include{2_bike/2_3_bike}
\include{2_bike/2_4_methods}
\include{2_bike/2_5_results}
\include{2_bike/2_6_atls}
\include{2_bike/2_7_sw}
\include{2_bike/2_8_conclusion}
